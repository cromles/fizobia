...
FREE_DATA_SOURCES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "auth": "none",
        "worker": "macro_strategist",
        "agent_id": "oam.expert.macro.local",
        "use": "Küresel piyasa cap ve BTC dominansı",
    },
    {
        "id": "cisa_kev",
        "name": "CISA KEV",
        ...
        "use": "Bilinen istismar edilen CVE kataloğu",
    },
    {
        "id": "defillama_yields",
        ...
        "auth": "none",
        "worker": "yield_strategist",
        "agent_id": "oam.expert.yield.local",
        "use": "DeFi yield havuzları APY/TVL",
    },
    {
        "id": "gemini_llm",
        "name": "Google Gemini",
